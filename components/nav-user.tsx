      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8 rounded-lg">
                ...
                <AvatarFallback className="rounded-lg">{session.data?.user?.name?.slice(0, 2)?.toUpperCase() || ''}</AvatarFallback>
              </Avatar>
          ...
          >
            ...
            <DropdownMenuItem className="left-2 text-red-600 " onClick={SignOut}>
              <LogOut  />
              Log out
            </DropdownMenuItem>
          </DropdownMenuContent>
