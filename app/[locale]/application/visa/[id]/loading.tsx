  ...
  return (
    <SidebarProvider>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <div className="space-y-2">
            <div className="relative flex items-center justify-between p-4 ">
              <h2 className="text-2xl font-semibold">Visa Application</h2>
              <Button
                variant="ghost"
                size={"icon"}
      ...
      <CardHeader className="border-b p-4 sm:p-3 bg-primary rounded-t-lg">
        <CardTitle className="text-lg text-primary-foreground">Passport Details</CardTitle>
      </CardHeader>
      <CardContent className="p-6">
        <div className="grid grid-cols-2 gap-6">
         ...
         <Card>
      <CardHeader className="border-b p-4 sm:p-3 bg-primary rounded-t-lg">
        <CardTitle className="text-lg text-primary-foreground">Manual Information</CardTitle>
      </CardHeader>
